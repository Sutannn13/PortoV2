                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            {showUserInfo && (
                                <div
                                    className="absolute z-[2] flex flex-row items-center justify-between backdrop-blur-[30px] border border-white/10 pointer-events-auto flex-wrap gap-2 sm:flex-nowrap sm:gap-0"
                                    style={
                                        {
                                            '--ui-inset': '12px',
                                            '--ui-radius-bias': '6px',
                        ...
                        >
                            <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                                <h3
                                    className="font-semibold m-0 leading-tight text-center"
                                    style={{
