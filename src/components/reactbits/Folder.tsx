        ...
        <div style={scaleStyle} className={className}>
            ...
            >
                ...
                >
                    ...
                    {papers.map((item, i) => {
                        let sizeClasses = '';
                        // Adjusted size classes to make items visible when closed too
                        ...
                        return (
                            <div
                                ...
                                className={`absolute z-20 bottom-[10%] left-1/2 transition-all duration-300 ease-in-out overflow-hidden flex items-center justify-center ${!open ? 'transform -translate-x-1/2 translate-y-[10%] group-hover:translate-y-0' : 'hover:scale-110'
                                    } ${sizeClasses}`}
                                style={{
